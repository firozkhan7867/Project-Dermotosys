...
const Signup = () => {
    const paperStyle = { padding: 20, width: 300, margin: "0 auto"  ,backgroundColor:'lavenderblush'}
    ...
    const validationSchema = Yup.object().shape({
        ...
        gender: Yup.string().oneOf(["male", "female"], "Select One").required("Required"),
        ...
        <nav>
            ...
            <Paper style={paperStyle}>
                <Grid align='center'>
                    ...
                    <Typography variant='caption' gutterBottom>Before you book your first appointment, complete the form below.</Typography>
                </Grid>
