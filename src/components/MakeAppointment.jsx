  ...
  return (
    <div className="container-fluid lg:m-16 shadow-lg">
      ...
      <h2 className="text-2xl text-center font-bold">MAKE AN APPOINTMENT</h2>
        ...
        <form >
        <div className="lg:grid lg:grid-cols-3 gap-4 justify-between flex-col mt-8">
          <input
            name="email"
            type="text"
            placeholder="Your Name"
            required
            className="border-b-2 w-full bg-white rounded-2 text-sm py-3 px-2 my-2 rounded-1xl text-black outline-none"
            />
            <input
            name="email"
            type="text"
          ...
          <input
            ...
            className="border-b-2 w-full bg-white rounded-2 text-sm py-3 px-2 my-2 rounded-1xl  text-black outline-none"
            />
            <select name="slot" className='border-b-2 w-full bg-white rounded-2 text-sm py-3 px-2 my-2 rounded-1xl text-black outline-none'>
            ...
            <select name="severity" className='border-b-2 w-full bg-white rounded-2 text-sm py-3 px-2 my-2 rounded-1xl text-black outline-none'>
        ...
        <input
            ...
            className="border-b-2 w-full h-full bg-white text-start rounded-2 text-sm py-3 px-2 my-2 rounded-1xl text-black outline-none"
            />
        </div>
