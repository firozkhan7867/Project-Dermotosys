                        ...
                        <div className="inline-block min-w-full  overflow-hidden">
                            <table className="min-w-full leading-normal text-center">
                                <thead>
                                    <tr>
                                        <th
                                            className="px-5 py-3 border-b-2  border-gray-200 w-3/12 text-center text-sm   uppercase tracking-wider">
                                            Patient Name
                                        </th>
                                        <th
                                            className="px-5 py-3 border-b-2  border-gray-200 w-2/12 text-center text-sm   text-gray-600 uppercase tracking-wider">
                                            Appt Date
                                        </th>
                                        <th
                                            className="px-5 py-3 border-b-2  border-gray-200 w-2/12 text-center text-sm   text-gray-600 uppercase tracking-wider">
                                        ...
                                        <th
                                            className="px-5 py-3 border-b-2  border-gray-200 w-3/12  text-center text-sm   text-gray-600 uppercase tracking-wider">
                                            Status
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white">
                                            <p className="text-gray-900 whitespace-no-wrap">General</p>
                                        </td>
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white">
                                            <p className="text-gray-900 whitespace-no-wrap">
                                                New Patient
